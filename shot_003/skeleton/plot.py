...
index = 1
while index < size:
    time_density.append(float(splitlines[index][0]))
...
index = 1
while index < size:
    time_diameter.append(float(splitlines[index][0]))
...
index = 1
while index < size:
    loop_time.append(float(splitlines[index][0]))
...
index = 1
while index < size:
    visible_void_time.append(float(splitlines[index][0]))
